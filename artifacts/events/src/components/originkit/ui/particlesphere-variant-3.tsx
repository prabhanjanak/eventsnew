// Originkit preset `variant-3` — props baked into the default export.
 ...
 * @framerDisableUnlink
 */
function __OriginkitBase_ParticleSphereRefactor(__props: ParticleSphereRefactorProps) {
    const {
...
export default function ParticleSphereRefactor(props: Partial<ParticleSphereRefactorProps>) {
  return <__OriginkitBase_ParticleSphereRefactor {...(__originkitPresetProps as any)} {...props} />;
}
