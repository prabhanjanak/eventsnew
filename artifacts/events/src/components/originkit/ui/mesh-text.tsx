...
const COMPONENT_DEFAULTS = {
  ...
  colorSplit: true,
  customColors: ["#38BDF8", "#818CF8", "#F59E0B"],
  force: 18,
};

export default function MeshText(props: Record<string, any>) {
  return <__OriginkitBase_MeshText {...COMPONENT_DEFAULTS} {...props} />;
}
